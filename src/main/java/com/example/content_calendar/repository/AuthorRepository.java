...
public interface AuthorRepository extends JpaRepository<Author, String> {
    ...
    @Query(value = "SELECT DISTINCT t FROM Content c JOIN c.author a JOIN c.tags t WHERE a.id = :authorId",
           countQuery = "SELECT COUNT(DISTINCT t) FROM Content c JOIN c.author a JOIN c.tags t WHERE a.id = :authorId")
    Page<Tags> findTagsByAuthorId(@Param("authorId") String authorId, Pageable pageable);
} 
